...
<head>
   ...
   <title>STM Placement Portal || St. Thomas College of Engineering & Technology, Sivapuram, Mattannur was established by St Thomas Educational Society, Adoor</title>
...
.bg-image {
  background-image: url('https://res.cloudinary.com/dvwfj3tqg/image/upload/v1664298883/image_2_qrww5r.png');
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            <h3 class="display-4">STM Placement Portal</h3>
